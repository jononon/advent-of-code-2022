...
class Part1 {
    ...
    public static void main(String args[]) throws FileNotFoundException {
        ...
        System.out.println(sumAllDirectoriesWithSize(100000, root));
    }
    ...
    public static int sumAllDirectoriesWithSize(int maxSize, Directory dir) {
        int sizeToReturn = 0;
        for (Directory subdirectory : dir.subdirectories.values()) {
            sizeToReturn += sumAllDirectoriesWithSize(maxSize, subdirectory);
        }
        if (dir.size <= maxSize) {
            sizeToReturn += dir.size;
        }
        return sizeToReturn;
    }
}
